...
# 
# # Create a data frame with all timestamps and initialize the value column to 0
# df <- data.frame(timestamp = timestamps, value = 0)
# 
# # Load the holiday data
# holidays <- holidays_2000_2030
# 
# # Convert the holiday Date column to Date type
# holidays$Date <- as.Date(holidays$Date)
# 
# # Create a vector of holiday dates
# holiday_dates <- unique(holidays$Date)
# 
# # Update the value column for holidays
# holidays_df_new <- df %>%
